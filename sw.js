...
const PRECACHE_LIST = [
  ...
  "./js/snackbar.js",
  "./img/icon_wechat.png",
  "./img/avatar-ziwei.jpg",
  "./img/home-bg.jpg",
  "./img/404-bg.jpg",
  "./css/yang-blog.min.css",
...
// Tracking https://twitter.com/yangpro/status/798816417097224193
...
function sendMessageToClientsAsync(msg) {
  ...
  // https://twitter.com/yangpro/status/799265578443751424
