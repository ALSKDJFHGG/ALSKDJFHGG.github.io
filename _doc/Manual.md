...
```yml
# Site settings
title: yang Blog             # title of your website
SEOTitle: yang Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: yangpro     # modify this account to yours
weibo_username: yangpro      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-ziwei.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“yang Blog”** but I want the title shows in search engine is **“黄玄的博客 | yang Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/yangpro/yangpro.github.io/issues/15) about code wrap.
